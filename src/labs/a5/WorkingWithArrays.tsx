...
function WorkingWithArrays() {
    ...
    const updateTitle = async () => {
      const response = await axios.get(`${API_BASE}/${todo.id}/title/${todo.title}`);
      setTodos(response.data);
    };
    ...
    return (
      <div>
        ...
        <a href={API_BASE} className="btn btn-primary">
          Get Todos
        </a>
        ...
        <input value={todo.id} onChange={(e) => setTodo({ ...todo,
          ...
          <a href={`${API_BASE}/${todo.id}`} className="btn btn-secondary" >
            Get Todo by ID
          </a>
          <h3>Filtering Array Items</h3>
          <a href={`${API_BASE}?completed1=true`} className="btn btn-secondary">
            Get Completed Todos
          </a>
          <h3>Deleting from an Array</h3>
          <a href={`${API_BASE}/${todo.id}/delete`}  className="btn btn-primary">
            Delete Todo with ID = {todo.id}
          </a>
          <br/><br/><br/>
          <h3>Creating new Items in an Array</h3>
          <a href={`${API_BASE}/create`} className="btn btn-secondary">
            Create Todo
          </a>
          ...
          <h3>Updating an Item in an Array</h3>
            ...
            <a href={`${API_BASE}/${todo.id}/title/${todo.title}`} className="ms-2 btn btn-primary">
              Update Title
            </a>
            <br/>
            <br/>
            ...
            <a href={`${API_BASE}/${todo.id}/descriptin/${todo.description}`} className="ms-2 btn btn-primary">
              Update Description
            </a>
            <br/>
            <br/>
            ...
            <a href={`${API_BASE}/${todo.id}/completed1/${done}`} className="ms-2 btn btn-primary">
              Update Completed
            </a>
            <br/>
            <br/>
