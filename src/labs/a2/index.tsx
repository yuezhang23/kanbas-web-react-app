...
----------------------------------
        <h3>ID selectors</h3>
        <p id="id-selector-1">
            Instead of changing the look and
            feel of all the elements of the
            same name, e.g., P, we can refer
            to a specific element by its ID
        </p>
        <p id="id-selector-2">
            Here's another paragraph using a
            different ID and a different look
            and feel
        </p>
        ----------------------------------
        ...
        <p className="wd-class-selector">
            ...
            element's CLASS attribute</p>
        <h4 className="wd-class-selector">
            This heading has same style as
            paragraph above</h4>
        ...
        <div className="wd-selector-1">
            ...
            <div className="wd-selector-2">
                ...
                <p className="wd-selector-3">
                    ...
                    <br/>
                    <span className="wd-selector-4">Whereas this span is a
    direct child of its parent</span>
                    <br/>
        ...
        <p className="wd-bg-color-red wd-fg-color-black">
            ...
            <span className="wd-bg-color-green wd-fg-color-white"> the background
of this text is green and the foreground white</span>
        ...
        ----------------------------------
        <h2>Padding</h2>
        <div className=" wd-border-red wd-border-solid
        wd-bg-color-yellow">
            Regular Padding
        </div>
        ...
        <div className="wd-margin-top-left
...
wd-bg-color-red wd-dimension-square">
        ...
        ----------------------------------
        <h3>Fixed </h3>
        <p> Checkout the blue square that says
    ...
    wd-bg-color-red wd-dimension-square">
        ...
        <div className="wd-grid-row">
            <div className="wd-grid-col-half-page-r wd-bg-color-yellow">
                <h3>Left half</h3>
            </div>
            <div className="wd-grid-col-half-page-r wd-bg-color-blue
            wd-fg-color-white">
                <h3>Right half</h3>
            </div>
        </div>
        ...
        <h2>Flex</h2>
        <div className="wd-flex-row-container">
            <div className="wd-bg-color-yellow wd-width-85px">
                Column 1
            </div>
            <div className="wd-bg-color-blue">Column 2</div>
            <div className="wd-bg-color-red wd-flex-grow-1">
        ...
        ----------------------------------
        <br/><br/>
    <h2><a href="https://getbootstrap.com/docs/5.1/layout/grid/">
        Grid system</a></h2>
    <div className="row">
...
----------------------------------
    ...
    <table className="table">
        ...
        <tfoot>
        <tr className="table-success"><td>Average</td><td>90</td></tr>
        </tfoot>
    </table>
    ...
    <div className="table-responsive">
        ...
        <div className="list-group">
            ...
            <a href="https://en.wikipedia.org/wiki/Ender%27s_Game" className="list-group-item list-group-item-action disabled"  aria-disabled="true">Ender's Game</a>
        </div>
        ...
        <div>
            <h2>Simple icons</h2>
            <i className="fa fa-cog"></i> <i className="fa fa-heart"></i>
            <i className="fa fa-share"></i> <i className="fa fa-comment"></i><br/>
            <i className="fa fa-image"></i> <i className="fa fa-chart-bar"></i>
            <i className="fa fa-calendar"></i> <i className="fa fa-smile"></i>
        </div>

        <h2>Resizing icons</h2>
        <i className="fa fa-cog fa-2x"></i><i className="fa fa-heart fa-2x"></i><i className="fa fa-share fa-3x"></i>
        <i className="fa fa-comment fa-3x"></i><br/><i className="fa fa-image fa-3x"></i><i className="fa fa-chart-bar fa-4x"></i>

        <h2>Brand icons</h2>
        <i className="fab fa-twitter fa-2x"></i><br/>
        <i className="fab fa-facebook fa-2x"></i><br/>
        <i className="fab fa-apple fa-2x"></i><br/>
        ...
        <div className="fa-4x">
            ...
            <i className="fas fa-snowboarding fa-rotate-90"></i>
            <i className="fas fa-snowboarding fa-rotate-180"></i><br/>
            <i className="fas fa-snowboarding fa-rotate-270"></i>
            <i className="fas fa-snowboarding fa-flip-horizontal"></i>
            <i className="fas fa-snowboarding fa-flip-vertical"></i><br/>
            <i className="fas fa-snowboarding fa-flip-both"></i><br/>
        </div>
        ...
        <div className="fa-3x">
            ...
            <i className="fas fa-sync fa-spin"></i><br/>
